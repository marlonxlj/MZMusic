...
public protocol KGDrawerAnimating {
    ...
    func openDrawer(side: KGDrawerSide, drawerView: UIView, centerView: UIView, animated: Bool, complete: (_ finished: Bool) -> Void)
    
    func dismissDrawer(side: KGDrawerSide, drawerView: UIView, centerView: UIView, animated: Bool, complete: (_ finished: Bool) -> Void)
