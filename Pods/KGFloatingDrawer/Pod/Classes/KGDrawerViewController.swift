...
public class KGDrawerViewController: UIViewController {
    ...
    public func openDrawer(side: KGDrawerSide, animated:Bool, complete: (_ finished: Bool) -> Void) {
    ...
    public func closeDrawer(side: KGDrawerSide, animated: Bool, complete: (_ finished: Bool) -> Void) {
    ...
    public func toggleDrawer(side: KGDrawerSide, animated: Bool, complete: (_ finished: Bool) -> Void) {
        if side != .None {
