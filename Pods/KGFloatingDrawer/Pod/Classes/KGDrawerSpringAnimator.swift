...
extension KGDrawerSpringAnimator: KGDrawerAnimating {
    ...
    public func openDrawer(side: KGDrawerSide, drawerView: UIView, centerView: UIView, animated: Bool, complete: (_ finished: Bool) -> Void) {
        if (animated) {
    ...
    public func dismissDrawer(side: KGDrawerSide, drawerView: UIView, centerView: UIView, animated: Bool, complete: (_ finished: Bool) -> Void) {
        if (animated) {
            UIView.animateWithDuration(animationDuration,
                delay: animationDelay,
                usingSpringWithDamping: springDamping,
